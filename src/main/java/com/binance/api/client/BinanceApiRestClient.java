...
public interface BinanceApiRestClient {
  ...
  DailyAccountSnapshot getDailySpotAccountSnapshot();
  DailyAccountSnapshot getDailyMarginAccountSnapshot();
  /**
  ...
  List<Trade> getMyTradesForOrder(String symbol, Long orderId);
