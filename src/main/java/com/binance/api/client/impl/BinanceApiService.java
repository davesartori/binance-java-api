...
public interface BinanceApiService {
    ...
    Call<DailyAccountSnapshot> getDailyAccountSnapshot(@Query("type") String type, @Query("timestamp") Long timestamp);
    ...
    Call<Deposit[]> getDepositHistory(@Query("asset") String asset, @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
